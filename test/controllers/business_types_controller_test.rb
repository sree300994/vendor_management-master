...
class BusinessTypesControllerTest < ActionController::TestCase
  ...
  test "should create business_type" do
    assert_difference('BusinessType.count') do
      post :create, business_type: { business_type: @business_type.business_type, name: @business_type.name, tin_number: @business_type.tin_number }
    end
  ...
  test "should update business_type" do
    patch :update, id: @business_type, business_type: { business_type: @business_type.business_type, name: @business_type.name, tin_number: @business_type.tin_number }
    assert_redirected_to business_type_path(assigns(:business_type))
  end
